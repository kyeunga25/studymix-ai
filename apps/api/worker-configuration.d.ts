/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 935fea47ea7cc829d598eacbbd0c71fa)
// Runtime types generated with workerd@1.20260722.1 2026-07-24 nodejs_compat
interface __BaseEnv_Env {
	AUDIO_BUCKET: R2Bucket;
	DB: D1Database;
	JOB_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	APP_ENV: string;
	...
	REAL_GENERATION_ENABLED: string;
	CREDIT_ACCOUNTING_ENABLED: string;
	CREDITS_PER_JOB: string;
	FAL_KEY: string;
	FAL_WEBHOOK_URL: string;
	FAL_WEBHOOK_USER_ID: string;
	FAL_OUTPUT_EXPIRATION_SECONDS: string;
	FAL_QUEUE_START_TIMEOUT_SECONDS: string;
	FAL_POLL_INTERVAL_SECONDS: string;
	FAL_MAX_POLL_ATTEMPTS: string;
	MAX_PROVIDER_OUTPUT_BYTES: string;
	PROVIDER_OUTPUT_TIMEOUT_SECONDS: string;
	JOB_WORKFLOW_ENABLED: string;
	R2_TRANSFER_ENABLED: string;
	...
	MAX_ACTIVE_UPLOADS_PER_OWNER: string;
	MAX_ACTIVE_JOBS_PER_OWNER: string;
	MAX_DAILY_JOBS_PER_OWNER: string;
	ABANDONED_UPLOAD_RETENTION_HOURS: string;
	SOURCE_RETENTION_HOURS: string;
	FAILED_ARTIFACT_RETENTION_HOURS: string;
	OUTPUT_RETENTION_HOURS: string;
	RETENTION_CLEANUP_BATCH_SIZE: string;
	UPLOAD_URL_TTL_SECONDS: string;
	DOWNLOAD_URL_TTL_SECONDS: string;
	GENERATION_WORKFLOW: Workflow<Parameters<import("./src/index").GenerationWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "OWNER_IDENTITY_PEPPER" | "DEV_AUTH_SUBJECT" | "LEGAL_CONTACT_EMAIL" | "GENERATION_PROVIDER" | "REAL_GENERATION_ENABLED" | "CREDIT_ACCOUNTING_ENABLED" | "CREDITS_PER_JOB" | "FAL_KEY" | "FAL_WEBHOOK_URL" | "FAL_WEBHOOK_USER_ID" | "FAL_OUTPUT_EXPIRATION_SECONDS" | "FAL_QUEUE_START_TIMEOUT_SECONDS" | "FAL_POLL_INTERVAL_SECONDS" | "FAL_MAX_POLL_ATTEMPTS" | "MAX_PROVIDER_OUTPUT_BYTES" | "PROVIDER_OUTPUT_TIMEOUT_SECONDS" | "JOB_WORKFLOW_ENABLED" | "R2_TRANSFER_ENABLED" | "RETENTION_CLEANUP_ENABLED" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_S3_ACCESS_KEY_ID" | "R2_S3_SECRET_ACCESS_KEY" | "MAX_UPLOAD_BYTES" | "MAX_ACTIVE_UPLOADS_PER_OWNER" | "MAX_ACTIVE_JOBS_PER_OWNER" | "MAX_DAILY_JOBS_PER_OWNER" | "ABANDONED_UPLOAD_RETENTION_HOURS" | "SOURCE_RETENTION_HOURS" | "FAILED_ARTIFACT_RETENTION_HOURS" | "OUTPUT_RETENTION_HOURS" | "RETENTION_CLEANUP_BATCH_SIZE" | "UPLOAD_URL_TTL_SECONDS" | "DOWNLOAD_URL_TTL_SECONDS">> {}
}
